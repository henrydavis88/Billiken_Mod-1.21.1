package net.walkingcarpet72.billikenmodneo.entity.client;// Made with Blockbench 4.11.2
...
public class BillikenModel<T extends BillikenEntity> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("modid", "billiken"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition eyelid_r1 = eyelid.addOrReplaceChild("eyelid_r1", CubeListBuilder.create().texOffs(-2, 42).addBox(1.8033F, -6.2678F, 3.0005F, 4.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.5F, 6.0F, -3.0005F, 0.0F, 0.0F, -0.7854F));
